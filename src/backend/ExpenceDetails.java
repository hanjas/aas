...
public class ExpenceDetails {
    ...
    public ExpenceDetails() throws Exception {
    ...
    public void insertExpence(String date, String category, String amount, String groupe) throws Exception{
        stmt.executeUpdate("Insert into expenceDetails ("
    ...
    public String getMaxId() throws SQLException {
        String id ="";
        rs = stmt.executeQuery("select max(id) as lastId from ExpenceDetails");
        while(rs.next()) {
