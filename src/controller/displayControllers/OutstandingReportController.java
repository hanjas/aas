...
public class OutstandingReportController implements Initializable {
    ...
    private void setOutstanders() throws Exception {
    ...
    private void show() throws Exception {
        if(!outstandingNameField.getEditor().getText().equals("")){
            DBAccess db = new DBAccess();
            HashMap param = new HashMap();
            param.put("outstandingName", outstandingNameField.getEditor().getText());
            param.put("fromDate", getFromDate());
            param.put("toDate", getToDate());
            JasperPrint print = JasperFillManager.fillReport("src\\reports\\OutstandingReport.jasper", param, db.connection);
            db.close();
    ...
    @FXML private ComboBox outstandingNameField;
