 ...
 * @author BCz
 */
public class InsertIncomeController implements Initializable {
    ...
    private void save() throws Exception{
        ...
        income.insertIncome(getDate(), categoryField.getText(), amountField.getText(), groupField.getText());
        income.close();
    }
    ...
    @FXML private void saveAndCloseOnMouse() throws Exception {
        if(checkFields()) {
            ...
            InfomationPopupWithMsg msg = new InfomationPopupWithMsg("Saved", "Income Saved");
            msg.initOwner(stage);
            msg.showAndWait();
            stage.close();
        } else {
