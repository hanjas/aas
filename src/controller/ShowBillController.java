...
public class ShowBillController implements Initializable {
    ...
    public void setTableDat(ObservableList tableList) {
    ...
    public void setTotalBillAmt(String totalBillAmt) {
        totalBillAmtLabel.setText(totalBillAmt);
    }
    public void setSubTotal() {
        subTotalLabel.setText( (Integer.parseInt(totalBillAmtLabel.getText()) - totalExp) +"");
    }
    ...
    public void setOldBalAndGrandTotal(String oldBal) {
        try {
            oldBalanceLabel.setText(oldBal);
            Long grandTotal = Long.parseLong(subTotalLabel.getText())+ Long.parseLong(oldBalanceLabel.getText());
    ...
    public void setCashPaid(String cashPaid) {
        if(cashPaid.equals("") || cashPaid.equals("0"))
            balanceLabel.setText(grandTotalLabel.getText());
        else {
            cashPaidLabel.setText(cashPaid);
            balanceLabel.setText( (Long.parseLong(grandTotalLabel.getText()) - Long.parseLong(cashPaid) )+"" );
        }
    }
    ...
    public void saveToDb() {
        try {
            ...
            seller.insertBillDetails(
                    ...
                    linerAmtLabel.getText(), otherExpLabel.getText(), partyExpLabel.getText(), totalBillAmtLabel.getText(),
                    totalExpLabel.getText(), subTotalLabel.getText(), oldBalanceLabel.getText(), grandTotalLabel.getText(),
                    cashPaidLabel.getText(), balanceLabel.getText()
            );
