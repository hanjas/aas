 ...
 * @author USER
 */
public class EditBillViewController implements Initializable {
    ...
    public void setTotalExp() {
        ...
        Long i = Long.parseLong(totalExpLabel.getText().replaceAll("," ,""));
    ...
    public void setSubTotal() {
        subTotalLabel.setText( (Integer.parseInt(totalBillAmtLabel.getText().replaceAll("," ,"").replaceAll("," ,"")) - totalExp) +"");
        Long i = Long.parseLong(subTotalLabel.getText().replaceAll("," ,"").replaceAll("," ,""));
    ...
    public void setOldBalAndGrandTotal(String oldBal) {
        try {
            ...
            Long grandTotal = Long.parseLong(subTotalLabel.getText().replaceAll("," ,"").replaceAll("," ,""))+ Long.parseLong(oldBalanceLabel.getText().replaceAll("," ,"").replaceAll("," ,""));
    ...
    public void setCashPaid(String cashPaid) {
        if(cashPaid.equals("") || cashPaid.equals("0")){
            Long i = Long.parseLong(grandTotalLabel.getText().replaceAll("," ,"").replaceAll(",", ""));
            ...
            i = Long.parseLong( (Long.parseLong(grandTotalLabel.getText().replaceAll("," ,"").replaceAll("," ,"")) - Long.parseLong(cashPaid) )+"" );
            balanceLabel.setText( NumberFormat.getNumberInstance(Locale.US).format(i) );
        }
    }
    ...
    public void setAdvCuttedOrNot(boolean cutted, int advAmt) {
        this.cutted = cutted;
        this.advAmt = advAmt;
    }
    public void saveToDb(String billNo) {
        try {
            ...
            seller.saveEditBill(
                    billNo,linerNameLabel.getText(), truckNoLabel.getText(), date, billNoLabel.getText(),commissionLabel.getText(),
                    ...
                    totalExpLabel.getText().replaceAll("," ,""), subTotalLabel.getText().replaceAll("," ,""), oldBalanceLabel.getText().replaceAll("," ,""), grandTotalLabel.getText().replaceAll("," ,""),
                    cashPaidLabel.getText().replaceAll("," ,""), balanceLabel.getText().replaceAll("," ,"")
            );
            seller.removeFishDetails(billNo);
            for (Iterator it = tableView.getItems().iterator(); it.hasNext();) {
                EditBillTableModel item = (EditBillTableModel) it.next();
                seller.insertFishDetails(item.getFishName(), item.getBoxCount(), item.getUnitPrice(), item.getRs(), billNo);
            }
            if(cutted){
                if(!advCuttLabel.isVisible()) {
                    seller.setEditDuplicateAdvance(advAmt, partyNameLabel.getText());
                }
            } else {
                if(advCuttLabel.isVisible())
