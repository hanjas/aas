 ...
 * @author USER
 */
public class EditExpenceController implements Initializable {
    ...
    @FXML private void showBtnAction() {
        try {
            ...
            ResultSet rs = db.getExpenceDetails(getFromDate(), getToDate());
