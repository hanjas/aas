...
public class EditInvestmentController implements Initializable {
    ...
    public void filterItems(String searchName) {
        ...
        try {
            ...
            for(Object name : filteredData) {
                ListWithDeleteAndRemoveBtn listBtn = new ListWithDeleteAndRemoveBtn(name.toString(), "investment", this);
    ...
    @FXML public void createInvestment() {
        Stage outstanding = new Stage();
        outstanding.setTitle("Create InvestmentGiven");
        outstanding.getIcons().add(new Image("/image/aas.png"));
        try{
            Pane myPane = (Pane)FXMLLoader.load(getClass().getResource("/view/CreateInvestment.fxml"));
    ...
    @FXML public void createInvestmentOnKeyPress(KeyEvent e) {
