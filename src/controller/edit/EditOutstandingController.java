 ...
 * @author USER
 */
public class EditOutstandingController implements Initializable {
    ...
    public void filterItems(String searchName) {
        ...
        try {
            ...
            for(Object name : filteredData) {
                ListWithDeleteAndRemoveBtn listBtn = new ListWithDeleteAndRemoveBtn(name.toString(), "outstander", this);
    ...
    @FXML public void createOutstanding() {
        Stage outstanding = new Stage();
        outstanding.setTitle("Create Outstanding");
        outstanding.getIcons().add(new Image("/image/aas.png"));
        try{
            Pane myPane = (Pane)FXMLLoader.load(getClass().getResource("/view/CreateOutstanding.fxml"));
    ...
    @FXML public void createOutstandingOnKeyPress(KeyEvent e) {
